...
class infoModel extends Database {
	...
	private function sendRegistrationMailer($password) {
		$subject = 'Dalatimes Magazine Registration';
		$from = array('subscription@dalaltimes.com' => 'Dalaltimes.com');
		$to = array(
              ...
              <div style="margin:0 25px;">
                  <div style="display:inline-block;vertical-align:middle;width:49%;">
                      <div style="float:left">
                          <img src="mailer-dtmagazinelogo.png" style="vertical-align:middle;display:inline-block; text-align:left;">
                      </div>
                  </div>
                  <div style="display:inline-block;vertical-align:middle;width:49%;">
                      <div style="float:right;">
                          <img src="mailer-dtlogo.png" style="vertical-align:middle;display:inline-block; text-align:right;">
                      </div>
                  </div>
              </div>
              <div style="margin:0 25px;">
                <div style="margin-top:40px;text-align:center;border-bottom:1px solid #e1e1e1;color:#00a7dd; font-size:20px; text-transform:uppercase;">
                  ...
                  <p>You for subscribing to Dalal Times. We are excited to have you join us and start discovering new ways to make most from the Indian stock market.</p>
		...
		$html = str_replace(array('[[USERNAME]]', '[[PASSWORD]]'), array($this->_userInputName, $password), $html);
	...
	private function sendChangePasswordMailer() {
		$subject = 'Dalatimes.com - Change Password';
		$from = array('subscription@dalaltimes.com' => 'Dalaltimes.com');
		$to = array(
	...
	private function sendForgotPasswordMailer($password) {
		$subject = 'Dalatimes.com - Forgot Password';
		$from = array('subscription@dalaltimes.com' => 'Dalaltimes.com');
		$to = array(
			$this->_forgotEmailId => '',
		);
