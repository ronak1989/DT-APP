...
class info extends infoModel {
	...
	public function __construct($id = NULL, $params = array()) {
		$this->_infoModel = new infoModel($id, $params);
	}
	...
	public function doVerification() {
		$this->_data = $this->_infoModel->performVerification();
		echo json_encode($this->_data);
	}

	public function register() {
		$this->_infoModel->registerUser();
		/*echo json_encode($this->_data);*/
	}

	public function login() {
		$this->_infoModel->loginUser();
		/*echo json_encode($this->_data);*/
	}
	...
	public function logout() {
		$this->_infoModel->logoutUser();
		$this->redirect("303", _CONST_WEB_URL);
		/*echo json_encode($this->_data);*/
	}

	public function changePassword() {
		$this->_infoModel->changePassword();
	}

	public function forgotPassword() {
		$this->_infoModel->resetPassword();
	}
}
