...
class dtx30Model extends Database {
              ...
              <div style="margin:0 25px;">
                  <div style="display:inline-block;vertical-align:middle;width:49%;">
                      <div style="float:left">
                          <img src="http://dtx30.dalaltimes.com/public/images/dtx30_sticky.jpg" style="vertical-align:middle;display:inline-block; text-align:left;">
                      </div>
                  </div>
                  <div style="display:inline-block;vertical-align:middle;width:49%;">
                      <div style="float:right;">
                          <img src="http://dtx30.dalaltimes.com/public/images/mailer-dtlogo.png" style="vertical-align:middle;display:inline-block; text-align:right;">
                      </div>
                  </div>
              </div>
              <div style="margin:0 25px;">
	...
	private function saveUser() {
		...
		$this->bindByValue('registered_from', '8');
		if ($this->execute()) {
