    <meta charset="UTF-8">
    <title>DTX30 | Dalaltimes.com</title>
  ...
  <!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
    ...
    <!-- baraja css -->
    <link rel="stylesheet" href="public/css/baraja.css" />

    <!-- Custom stylesheet-->
    <link rel="stylesheet" href="public/css/style.css">
    <link rel="stylesheet" href="public/css/responsive.css" media="screen">
    <link href="public/css/jquery.mCustomScrollbar.css" rel="stylesheet" type="text/css">
    <!-- Added google font -->
