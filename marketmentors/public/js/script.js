...
$(document).ready(function() {
  ...
  $(document).on('click',"#forgotpassword, #changepassword, #register, #login, #signin, #signup",function(e) {
    e.preventDefault();
    e.stopPropagation();
    var error = 0;
        ...
        $.ajax({
          ...
          success: function( response, textStatus, jQxhr ){
            if(response['error']=='generic'){
              ...
              $('#registration_sub').html('<div style="color:#000000;font-weight:bold;"><div style="padding:50px 20px 0px;text-align:center;"><p>Your Dalal Times account password will be sent to the registered Email-ID</p></div><div style="text-align:center;padding-bottom:50px;">You will be redirected in <span id="redirect_cntr">5</span> secs</div></div>');
