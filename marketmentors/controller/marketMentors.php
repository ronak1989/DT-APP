...
class marketMentors extends marketMentorsModel {

	static private $_pageType = 'nonloggedin';
	private $_marketMentorsModel = NULL;
	private $_data = array();
	...
	public function __construct($id = NULL, $params = array()) {
		$this->_marketMentorsModel = new marketMentorsModel($id, $params);
	}
                    ...
                    <div class="row">
                      <div class="col-sm-12 ">
                        <form class="form-horizontal" name="signup-form" id="signup-form" role="form" action="redirect" method="POST">
                            ...
                            <div class="form-group form-fields-width">
                              <div onclick="removeErrorMsg(this);" style="color:#000000;" id="term_condition_container" class="checkbox">
	...
	public function doVerification() {
		$this->_data = $this->_marketMentorsModel->performVerification();
		echo json_encode($this->_data);
	}

	public function register() {
		$this->_marketMentorsModel->registerUser();
		/*echo json_encode($this->_data);*/
	}

	public function login() {
		$this->_marketMentorsModel->loginUser();
		/*echo json_encode($this->_data);*/
	}
	...
	public function logout() {
		$this->_marketMentorsModel->logoutUser();
		$this->redirect("303", _CONST_WEB_URL);
		/*echo json_encode($this->_data);*/
	}

	public function changePassword() {
		$this->_marketMentorsModel->changePassword();
	}

	public function forgotPassword() {
		$this->_marketMentorsModel->resetPassword();
	}
}
