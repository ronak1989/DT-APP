        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-1 navlogo-left">
              <img src="public/images/magazinelogo_white_stickyheader.png">
            </div>
          ...
          <div class="row">
            <div class="col-sm-3">
              ...
              <div class="navbar-header">
                ...
                <h1><a class="nav-brand" href="">Dalaltimes Magazine</a></h1>
              </div>
            </div>
            <div class="col-sm-9" id="static_menu">
              ...
              <div class="collapse navbar-collapse navbar-example" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                  ...
                  <li><a href="<?php echo _CONST_WEB_URL;?>#about_dt_sub">About Magazine</a></li>
