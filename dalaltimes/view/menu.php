<div class="wsmenucontainer clearfix">
  ...
  <div class="wsmenuexpandermain slideRight">
    ...
    <a href="<?php echo _CONST_WEB_URL; ?>/" class="smallogo"><img src="<?php echo _CONST_IMAGE_URL; ?>logo.png" alt=""></a>
  ...
  <section  class="navigation <?php echo $menuClass; ?>">
      <header style="padding:10px 0;">
        <div class="logo">
          <a href="<?php echo _CONST_WEB_URL; ?>/">
            <!--[if gte IE 10]><!-->
            <!-- DT LOGO -->
	...
	if (in_array(strtolower($value['name']), array("", 'mutual funds', 'the forecaster'))) {
		continue;
	}
