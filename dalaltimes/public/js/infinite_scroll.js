      ...
      '<article id="article-'+_articleDetails.autono+'" class="article article-block">',
            ...
            '<figure class="article-image size-extra-large ">',
                '<picture>',
                    ...
                    '<source srcset="'+_articleDetails.image_300+', '+_articleDetails.image_615+' 2x" media="(max-width: 450px)">',
                    '<img itemprop="image" srcset="'+_articleDetails.image_1600+'" alt="" title="" class="img-responsive">',
                '</picture>',
